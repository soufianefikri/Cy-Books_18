...
public abstract class UpdateUserBase extends AnchorPane {
    ...
    protected final HBox hBox_adress;
    ...
    public UpdateUserBase(int id) {
        ...
        //imageView.setImage(new Image(getClass().getResource("UpdateInfo/write.png").toExternalForm()));
        ...
        hBox_adress.setAlignment(javafx.geometry.Pos.CENTER);
        hBox_adress.setLayoutX(10.0);
        hBox_adress.setLayoutY(10.0);
        hBox_adress.setPrefHeight(132.0);
        hBox_adress.setPrefWidth(100.0);
        hBox_adress.setSpacing(32.0);
        ...
        hBox_adress.getChildren().add(vBox2);
        vBox3.getChildren().add(label2);
        vBox3.getChildren().add(city_field);
        hBox_adress.getChildren().add(vBox3);
        vBox4.getChildren().add(label3);
        vBox4.getChildren().add(zipcode_field);
        hBox_adress.getChildren().add(vBox4);
        vBox.getChildren().add(hBox_adress);
