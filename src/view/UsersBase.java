...
public abstract class UsersBase extends AnchorPane {
    ...
    public UsersBase() {
        ...
        vBox_bg.getStylesheets().add("styles/style_users.css");

        hBox.setAlignment(javafx.geometry.Pos.CENTER);
        hBox.setId("hBox");
        hBox.setPrefHeight(100.0);
        hBox.setPrefWidth(200.0);
        hBox.getStylesheets().add("styles/style_users.css");
        ...
        btn_home.getStylesheets().add("styles/style_users.css");
        ...
        btn_new.setOnAction(this::newUser);
        btn_new.setPrefHeight(37.0);
        btn_new.setPrefWidth(201.0);
        btn_new.getStylesheets().add("styles/style_users.css");
        ...
        textField.getStylesheets().add("styles/style_users.css");
        ...
        btn_search.getStylesheets().add("styles/style_users.css");
        ...
        btn_change.setOnAction(this::changeUser);
        btn_change.setPrefHeight(44.0);
        btn_change.setPrefWidth(209.0);
        btn_change.getStylesheets().add("styles/style_users.css");
        ...
        list_view.getStylesheets().add("styles/style_users.css");
    ...
    protected abstract void newUser(javafx.event.ActionEvent actionEvent);

    protected abstract void changeUser(javafx.event.ActionEvent actionEvent);
