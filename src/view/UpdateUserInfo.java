...
/**
 * This class is used to change the information of an existing user
 *  @author Soufiane Fikri
 *  
 *  
 */
public class UpdateUserInfo {
    UpdateUserBaseController menu;
    
    /**
     * this method is david's
     * @param uub instance of UpdateUserBaseController
     */
    public UpdateUserInfo(UpdateUserBaseController uub){
        this.menu = uub;
    }
    /**
     * This method is david's
    ...
    /**
     * This method updates the user informations according to what has been changes
     * @param event - is used as an event for a button in the parent scene
     ...
     * @param id - int is the id the user in the data base that has been transmitted to this method from the parent scene which shows the user information
     */

	public void updateUserInfo(ActionEvent event, TextField firstname_field, TextField lastname_field,
    TextField address_field,TextField zipcode_field,TextField city_field,
    TextField email_field,TextField number_field, int id) {
		// checks the integrity of the strings in the text fields
		...
		if(check_firstname && check_lastname && check_address && check_city && check_zipcode && check_email && check_number) {
			...
			connexion.changeUserInfo(id,firstname,lastname,address,email,phone);
