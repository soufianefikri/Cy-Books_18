...
public class UpdateInfo {
    ...
    public UpdateInfo(UpdateUserBaseController uub){
        this.menu = uub;
    }
    public UpdateInfo(){
    }
	...
	public void user_update(ActionEvent event, TextField firstname_field, TextField lastname_field,
    ...
    TextField email_field,TextField number_field, int id) {
		...
		if(check_firstname && check_lastname && check_address && check_city && check_zipcode && check_email && check_number) {
			...
			connexion.updateUser(id,firstname,lastname,address,email,phone);
