...
public abstract class MenuBase extends AnchorPane {
    ...
    */
    ...
    protected abstract void menu(javafx.event.ActionEvent actionEvent);

    protected abstract void customer(javafx.event.ActionEvent actionEvent);

    protected abstract void books(javafx.event.ActionEvent actionEvent);

    protected abstract void close_menu(javafx.event.ActionEvent actionEvent);
