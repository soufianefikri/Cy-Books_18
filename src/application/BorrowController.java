...
public class BorrowController extends BorrowBase{
    ...
    public void search(){
        ...
        menu.connexion co = new connexion();
        System.out.println("test1");
        ...
        list_view.getSelectionModel().selectedItemProperty().addListener(new ChangeListener<String>() {
            ...
            public void changed(ObservableValue<? extends String> observable, String oldValue, String newValue) {
                menu.User u = menu.connexion.getUser(list_view.getSelectionModel().getSelectedItem().toString());
    ...
    public void borrow(){
        menu.connexion.registerLoan(isbn, title, id_user, nb,datePicker.getValue());
    }
