...
public class MenuBase extends AnchorPane {
    ...
    public MenuBase() {
        ...
        vBox.getStylesheets().add("//Java/style_menu.css");
        ...
        btn_menu.getStylesheets().add("//Java/style_menu.css");
        ...
        btn_customer.getStylesheets().add("//Java/style_menu.css");
        ...
        btn_books.getStylesheets().add("//Java/style_menu.css");
        ...
        btn_close_menu.getStylesheets().add("//Java/style_menu.css");
        ...
        btn_calendar.getStylesheets().add("//Java/style_menu.css");
        ...
        btn_borrow.getStylesheets().add("//Java/style_menu.css");
        ...
        btn_param.getStylesheets().add("//Java/style_menu.css");
        ...
        btn_leave.getStylesheets().add("//Java/style_menu.css");
