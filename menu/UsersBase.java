...
public class UsersBase extends VBox {
    ...
    protected final Text text_adress;
    ...
    public UsersBase() {
        ...
        setPrefWidth(800.0);
        setSpacing(10.0);
        getStylesheets().add("//Java/style_users.css");
        ...
        text_adress.setStrokeType(javafx.scene.shape.StrokeType.OUTSIDE);
        text_adress.setStrokeWidth(0.0);
        text_adress.setText("adresse");
        text_adress.setFont(new Font(28.0));
        ...
        list_view.setLayoutX(126.0);
        list_view.setLayoutY(119.0);
        list_view.setPrefHeight(266.0);
        list_view.setPrefWidth(349.0);
        ...
        textFlow4.getChildren().add(text_adress);
    ...
    public void search_view(){
        ...
        list_view.getSelectionModel().selectedItemProperty().addListener(new ChangeListener<String>() {
            ...
            public void changed(ObservableValue<? extends String> observable, String oldValue, String newValue) {
                System.out.println(list_view.getSelectionModel().getSelectedItem());
            }
    ...
    */
    ...
    protected void search(javafx.event.ActionEvent actionEvent){
        connexion dbConn = new connexion();
        String words = textField.getText();
        try{
            u = dbConn.getUtilisateursFromDatabase(words);
        } catch (Exception e){
        ...
        if (u != null){
            ...
            text_adress.setText(u.getAdress());
