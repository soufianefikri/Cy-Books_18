...
public class RegisterBase extends AnchorPane {
    ...
    public RegisterBase() {
        ...
        hBox_name.getStylesheets().add("style_users.css");
        ...
        hBox_address.getStylesheets().add("style_users.css");
        ...
        hBox_contact.getStylesheets().add("style_users.css");
    ...
    protected void check_input(javafx.event.ActionEvent actionEvent){
        test_register reg = new test_register();
